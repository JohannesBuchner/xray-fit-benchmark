...
set_stat('cstat')
set_model(1, xstbabs.galabso * (xsapec.a1 + xsapec.a2 + xsapec.a3 + xsapec.a4 + xsapec.a5 + xsapec.a6 + xsapec.a7))
...
xsapec.a6.kT = 0.6
xsapec.a7.kT = 0.7
mymodel = xstbabs.galabso * (torus + omni)
set_model(2, mymodel)
set_model(3, mymodel)
...
def reset_norms(factor = 1):
	for ai in xsapec.a1, xsapec.a2, xsapec.a3, xsapec.a4, xsapec.a5, xsapec.a6, xsapec.a7:
		ai.norm = np.random.uniform(0, factor)
	torus.norm = np.random.uniform(0, factor)
	omni.norm = np.random.uniform(0, factor)
	return calc_stat()
